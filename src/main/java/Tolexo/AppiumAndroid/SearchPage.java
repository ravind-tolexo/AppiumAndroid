...
public class SearchPage {
	...
	By realSearchTextBox = By
			.xpath("//android.widget.FrameLayout/android.view.View/android.widget.LinearLayout/"
	...
	public void searchResultPage() throws InterruptedException {
		...
		System.out.println("Total count of items got searched are = "
				+ list.size());
	}
	...
	public String getSearchHeader() {
		WebElement text = driver
				.findElement(By
						.xpath("//android.widget.FrameLayout[@index='2']/android.widget.LinearLayout/"
								+ "android.widget.TextView[@text='No result found']"));
	...
	public void noResultPage() throws InterruptedException {
		...
		Thread.sleep(3000L);
		driver.sendKeyEvent(66);
		System.out.println("Enter key tapped");
